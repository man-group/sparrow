...
#    pragma GCC diagnostic ignored "-Wcast-align"
    ...
    template <
        ...
        requires(
            std::convertible_to<std::ranges::range_value_t<OFFSET_BUFFER_RANGE>, typename list_view_array_impl<BIG>::offset_type>
            && std::convertible_to<std::ranges::range_value_t<SIZE_RANGE>, typename list_view_array_impl<BIG>::list_size_type>
        )
    arrow_proxy list_view_array_impl<BIG>::create_proxy(
        array&& flat_values,
        OFFSET_BUFFER_RANGE&& list_offsets,
