...
namespace sparrow
{
    ...
    private:
        ...
        static arrow_proxy
        create_proxy(std::uint64_t list_size, array&& flat_values, R&& validity_input = validity_bitmap{});
...
#    pragma GCC diagnostic ignored "-Wcast-align"
    ...
    arrow_proxy
    list_array_impl<BIG>::create_proxy(array&& flat_values, offset_buffer_type&& list_offsets, VB&& validity_input)
    {
...
#    pragma GCC diagnostic pop
    ...
    inline arrow_proxy
    fixed_sized_list_array::create_proxy(std::uint64_t list_size, array&& flat_values, R&& validity_input)
    {
