...
namespace sparrow
{
    ...
    template <bool SPARROW_CONST>
    class run_encoded_array_iterator : public iterator_base<
                                           run_encoded_array_iterator<SPARROW_CONST>,
    ...
    private:
        ...
        using array_ptr_type = std::conditional_t<SPARROW_CONST, const run_end_encoded_array*, run_end_encoded_array*>;
    ...
    template <bool SPARROW_CONST>
    run_encoded_array_iterator<SPARROW_CONST>::run_encoded_array_iterator(
    ...
    template <bool SPARROW_CONST>
    bool run_encoded_array_iterator<SPARROW_CONST>::equal(const run_encoded_array_iterator& rhs) const
    {
        return m_index == rhs.m_index;
    }

    template <bool SPARROW_CONST>
    void run_encoded_array_iterator<SPARROW_CONST>::increment()
    {
        ++m_index;
        --m_runs_left;
    ...
    template <bool SPARROW_CONST>
    typename array_traits::const_reference run_encoded_array_iterator<SPARROW_CONST>::dereference() const
    {
