...
namespace sparrow
{
    ...
    namespace detail
    {
        ...
        template<>
        struct get_data_type_from_array<decimal_32_array>{constexpr static sparrow::data_type get(){return sparrow::data_type::DECIMAL32;}};

        template<>
        struct get_data_type_from_array<decimal_64_array>{constexpr static sparrow::data_type get(){return sparrow::data_type::DECIMAL64;}};

        template<>
        struct get_data_type_from_array<decimal_128_array>{constexpr static sparrow::data_type get(){return sparrow::data_type::DECIMAL128;}};
    ...
    private:
        ...
        static auto create_proxy(u8_buffer<storage_type>&& data_buffer, R&& bitmaps, std::size_t precision, int scale) -> arrow_proxy;

        static auto create_proxy(u8_buffer<storage_type>&& data_buffer, std::size_t precision, int scale) -> arrow_proxy;
    ...
    template <class T>
    auto decimal_array<T>::create_proxy(u8_buffer<storage_type>&& data_buffer, std::size_t precision, int scale) -> arrow_proxy
    {   
