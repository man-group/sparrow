...
namespace sparrow
{
    ...
    struct arrow_array_private_data
    {
        arrow_array_private_data(
            ...
            std::optional<std::vector<arrow_array_shared_ptr>> children,
        ...
        [[nodiscard]] const std::optional<std::vector<arrow_array_shared_ptr>>& children() const noexcept;
        ...
        std::optional<std::vector<arrow_array_shared_ptr>> m_children;
    ...
    template <class B, class C, class D>
        requires std::constructible_from<decltype(arrow_array_private_data::m_buffers), B>
                 && std::constructible_from<decltype(arrow_array_private_data::m_children), C>
                 && std::constructible_from<decltype(arrow_array_private_data::m_dictionary), D>
