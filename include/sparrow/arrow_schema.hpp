...
namespace sparrow
{
    ...
    public:
        ...
        arrow_schema_shared_ptr(const arrow_schema_shared_ptr& ptr) noexcept
            : std::shared_ptr<ArrowSchema>(ptr)
        {
        }

        arrow_schema_shared_ptr(arrow_schema_unique_ptr&& ptr)
            : std::shared_ptr<ArrowSchema>(std::move(ptr).release(), arrow_schema_custom_deleter)
        {
        }

        arrow_schema_shared_ptr(std::nullptr_t) noexcept
            : std::shared_ptr<ArrowSchema>(nullptr, arrow_schema_custom_deleter)
        {
        }
    };
    ...
    struct arrow_schema_private_data
    {
        ...
        template <class F, class N, class M, class C, class D>
            requires mpl::is_same_relaxed<F, std::string> && mpl::is_same_relaxed<N, std::optional<std::string>>
                     && mpl::is_same_relaxed<M, std::optional<std::string>>
                     && mpl::is_same_relaxed<C, std::vector<arrow_schema_shared_ptr>>
                     && mpl::is_same_relaxed<D, arrow_schema_shared_ptr>
    ...
    private:
        ...
        std::vector<arrow_schema_shared_ptr> m_children;
