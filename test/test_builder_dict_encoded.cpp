    ...
    TEST_SUITE("builder")
    {
        TEST_CASE("dict-encoded")
        {
            SUBCASE("dict[int]")
            {
                SUBCASE("no-nulls")
                {
                    dict_encode<std::vector<int>> v{std::vector<int>{1, 1, 1, 2}};
            ...
            SUBCASE("list[dict[int]]")
            {
                SUBCASE("without-nulls")
                {
                    std::vector<dict_encode<std::vector<int>>> v{
                        dict_encode<std::vector<int>>{std::vector<int>{1, 2, 3}},
                        dict_encode<std::vector<int>>{std::vector<int>{4, 5}},
                        dict_encode<std::vector<int>>{std::vector<int>{6}}
                    };
                ...
                SUBCASE("with-nulls")
                {
                    std::vector<nullable<dict_encode<std::vector<nullable<int>>>>> v{
                        dict_encode<std::vector<nullable<int>>>{std::vector<nullable<int>>{1, 2, 3}},
                        sparrow::nullval,
                        dict_encode<std::vector<nullable<int>>>{std::vector<nullable<int>>{6}},
                        dict_encode<std::vector<nullable<int>>>{std::vector<nullable<int>>{nullable<int>{}}},
                    };
                ...
                SUBCASE("with-nulls")
                {
                    std::vector<nullable<std::tuple<dict_encode<nullable<std::string>>, int>>> v{
                        std::tuple<dict_encode<nullable<std::string>>, int>{
                            dict_encode<nullable<std::string>>{"hello"},
                            1
                        },
                        ...
                        std::tuple<dict_encode<nullable<std::string>>, int>{
                            dict_encode<nullable<std::string>>{nullable<std::string>{}},
                            4
                        }
                    };
                    auto arr = sparrow::build(v);
            ...
            SUBCASE("union[[dict[string], int]]")
            {
                SUBCASE("without-nulls")
                {
                    ...
                    std::vector<variant_type> v{
                        variant_type{dict_encode<std::string>{"hello"}},
                        variant_type{int(42)},
                    };
                    auto arr = sparrow::build(v);
                    test::generic_consistency_test(arr);
                ...
                SUBCASE("with-nulls")
                {
                    using variant_type = std::variant<dict_encode<nullable<std::string>>, nullable<int>>;
                    std::vector<variant_type> v{
