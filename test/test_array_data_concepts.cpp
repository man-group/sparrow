...
namespace sparrow
{
    static_assert(is_a_supported_layout<fixed_size_layout<int>>);
    static_assert(is_a_supported_layout<variable_size_binary_layout<std::string, std::string_view, const std::string_view>>);
    static_assert(is_a_supported_layout<dictionary_encoded_layout<size_t, variable_size_binary_layout<std::string, std::string_view, const std::string_view>>>);
    static_assert(!is_a_supported_layout<std::string>);
